...
"x86_64-linux-thread-multi-4.1.20-0-grsec" or
	die "Errno architecture (x86_64-linux-thread-multi-4.1.20-0-grsec) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
